...
public class ParentalControlController {
  ...
  @PostMapping(value = "/parental-control", consumes = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<Boolean> isMoviePermitted(@RequestBody Input input)
    ...
    return new ResponseEntity<Boolean>(parentalControlService.isMoviePermitted(input),
        HttpStatus.OK);
